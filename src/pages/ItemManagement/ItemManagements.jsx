...
export default function ItemManagements() {
  ...
  const handleConfirmDelete = async () => {
    try {
      ...
      message.error(error.message || "Xóa món ăn không thành công");
    } finally {
  ...
  const handleCategoryModalOk = async () => {
    try {
      ...
      message.error(error.message || "Tạo danh mục không thành công");
    }
  };
  ...
  const handleConfirmDeleteCategory = async () => {
    try {
      ...
      message.error(error.message || "Xóa danh mục không thành công");
    } finally {
