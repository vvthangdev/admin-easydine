    ...
    <Box sx={{ py: 8, px: { xs: 2, md: 10 }, bgcolor: "background.paper" }}>
      <Box sx={{ textAlign: "center", mb: 6 }}>
        ...
        <Typography
          ...
          mx="auto"
        >
          Khám phá những món ăn được yêu thích nhất tại nhà hàng chúng tôi, được
          chế biến từ những nguyên liệu tươi ngon nhất
        </Typography>
      </Box>
        ...
        {categories.map((category) => (
          <Button
            ...
            sx={{
              ...
              "&:hover": {
                bgcolor:
                  activeCategory === category ? "primary.dark" : "grey.200",
              },
            }}
          >
            {category}
