    ...
    <Box
      ...
      sx={{
        ...
        "&:before": {
          ...
          bottom: 0,
          background:
            "radial-gradient(circle at bottom right, rgba(0, 122, 255, 0.08), transparent 70%)",
          zIndex: 0,
        },
      }}
    >
      ...
      >
        ...
        <Typography variant="body1" color="#86868b">
          ...
          nhất với chất lượng phục vụ hàng đầu
        </Typography>
      </Box>
        ...
        {features.map((feature) => (
          <Grid item xs={12} sm={6} md={3} key={feature.id}>
            ...
            >
              ...
              <Divider
                sx={{ my: 2, bgcolor: "rgba(0, 0, 0, 0.1)" }}
          ...
          <Box display="flex" justifyContent="center" gap={2} flexWrap="wrap">
            <Button
              ...
              sx={{
                ...
                "&:hover": {
                  background:
                    "linear-gradient(145deg, #0077ed 0%, #2196f3 100%)",
