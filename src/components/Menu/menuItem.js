...
export default function MenuItems() {
  ...
  // Điều hướng đến trang đặt takeaway
  const handleGoToTakeawayOrder = () => {
    navigate("/takeaway", { state: { cart } }); // Chuyển hướng đến trang đặt takeaway
  };
        ...
        <div className="space-y-4">
          {cart.map((item) => (
            ...
            >
              <div>
                ...
                <span className="text-sm text-gray-500 ml-80">
                  {item.price.toLocaleString()}₫
                </span>
              </div>
              <Popconfirm
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              <Button
                onClick={handleGoToTakeawayOrder} // Chuyển hướng đến trang đặt bàn
                className="px-4 py-2 rounded-lg font-medium text-white bg-amber-500 hover:bg-amber-600"
              >
                Đặt Takeaway
              </Button>
