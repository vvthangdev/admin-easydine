...
export default function Sidebar({ onCollapseChange }) {
  ...
  return (
    <div className={`text-white transition-all duration-500 ease-in-out ${isCollapsed ? 'w-16' : 'w-64'} bg-gradient-to-b from-gray-900/90 to-black/90 backdrop-blur-xl border-r border-gray-800/20 shadow-lg h-full`}>
